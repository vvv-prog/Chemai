...
- **🔄 更新情况**：🟢 **v3.1.x** 系列；新增内置可直接下载的预训练模型（如 **DPA3**）、分布式训练与更多优化器。开发非常活跃（DeepModeling 社区）;v3.2.0（DPA4）测试版发布中。
...
- **🔄 更新情况**：🟢 最新 **v0.3.16**（2025-05-10）;基础模型与代码持续迭代。
...
- **🔄 更新情况**：🟢 最新打包发布 **fairchem-core v2.21.0**（2025-06-08）;UMA 模型与代码持续开发中。
...
- **🎯 使用方向**：原子神经网络**建模工具箱**（SchNet、PaiNN 等），含数据管线与内置 MD，
  适合方法学习、研究与自定义模型开发。
- **🔄 更新情况**：🟡 SchNetPack **2.x** 系列,最新 **v2.2.0**（2024-12-19）。稳定维护。
